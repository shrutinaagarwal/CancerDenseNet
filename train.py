...
from keras.layers import Input, Add, Dense,Concatenate, Activation,merge , ZeroPadding2D, BatchNormalization, Flatten, Conv2D, AveragePooling2D, GlobalAveragePooling2D, MaxPooling2D, GlobalMaxPooling2D
...
model.save('my_densenet50')
    #print(model_files[i])
    #print(history.history.keys())  
save_history(history.history,'history_densenet')
